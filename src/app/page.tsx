...
export default function Home() {
  ...
  const exportData = () => {
    V1.downloadAsFile(name, JSON.stringify(items), 'application/json');
  }

  const importData = async function () {
    const file = await V1.readTextFile();
        ...
        <div className="flex">
          <div className="flex h-[40px]">
            ...
            <input type="name" id="name"
                   defaultValue={name}
                   className="mr-8 max-w-[100px] bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
            ...
            <label htmlFor="m21" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white w-[50px] p-2">m2 ></label>
